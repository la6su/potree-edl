 ...
 * ```
 */
interface PickableFeatures<TFeature = unknown, TResult extends PickResult<TFeature> = PickResult<TFeature>, TOptions extends PickOptions = PickOptions> {
    readonly isPickableFeatures: true;
    /**
 ...
 */
export declare const isPickableFeatures: (obj: unknown) => obj is PickableFeatures;
export default PickableFeatures;
//# sourceMappingURL=PickableFeatures.d.ts.map