 ...
 */
function toFlatCoordinates(geojson) {
 ...
 */
function fromFlat3Coordinates(flat3Coords, geometryType) {
 ...
 * @returns GeoJSON geometry object
 */
function fromFlatCoordinates(flatCoords, geometryType) {
...
function getOpenLayersGeometry(geometry) {
...
function getOpenLayersFeature(feature) {
  return new Feature({
